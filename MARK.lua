...
send(msg.chat_id_, msg.id_," ❈ عذرا الملف لايدعم سورس مارك \n") 
end
return false
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'مارك').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'مارك')
local MARK_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'مارك').." غادر" or text == 'غادر' then  
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'مارك')
